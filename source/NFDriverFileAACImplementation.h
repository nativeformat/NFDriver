...
class NFDriverFileAACImplementation : public NFDriver {
 public:
  bool isPlaying() const;
  void setPlaying(bool playing);

  NFDriverFileAACImplementation(void *clientdata,
 ...
 private:
  ...
  static void run(NFDriverFileAACImplementation *driver);
};
